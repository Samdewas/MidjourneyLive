...
import Subscription from './my-account/Subscription';
import BillingHistory from './my-account/BillingHistory';
...
const MyAccount = () => {
  ...
  return (
    <>
      <PrivateRoute />
      <Helmet>
            <title> My Account | Mid Journey </title>
            </Helmet>
      <section className='main-container-dashboard'>
        <div className='subscription_page'>
          <Tab.Container id="left-tabs-example" defaultActiveKey="first">
            <Row className='m-0'>
              <Col sm={4}>
                {isDesktop || showAccountMenu === false ?
                  <div className='my-account-navigation' onClick={() => setShowAccountMenu(!showAccountMenu)}>
                    <Nav variant="pills" className="flex-column">
                      <Nav.Item>
                        <Nav.Link eventKey="first">
                          ...
                          <svg className="neg-transition-scale" xmlns="http://www.w3.org/2000/svg" width="18" height="18" viewBox="0 0 18 18" fill="none">
                            <path fill-rule="evenodd" clip-rule="evenodd" d="M1.125 9C1.125 8.68934 1.37684 8.4375 1.6875 8.4375H14.9545L11.4148 4.89775C11.1951 4.67808 11.1951 4.32192 11.4148 4.10225C11.6344 3.88258 11.9906 3.88258 12.2102 4.10225L16.7102 8.60225C16.9299 8.82192 16.9299 9.17808 16.7102 9.39775L12.2102 13.8977C11.9906 14.1174 11.6344 14.1174 11.4148 13.8977C11.1951 13.6781 11.1951 13.3219 11.4148 13.1023L14.9545 9.5625H1.6875C1.37684 9.5625 1.125 9.31066 1.125 9Z" fill="#fff"></path>
                          </svg>
                        </Nav.Link>
                      </Nav.Item>
                      <Nav.Item>
                        <Nav.Link eventKey="second">
                          <div className='left-data'>
                            <svg className="neg-transition-scale" width="18" height="18" viewBox="0 0 18 18" fill="none" xmlns="http://www.w3.org/2000/svg">
                              ...
                              <path d="M0 12.375V13.5C0 14.7426 1.00736 15.75 2.25 15.75H15.75C16.9926 15.75 18 14.7426 18 13.5V12.375H0Z" fill="url(#paint1_linear_2555_1960)"></path>
                              <defs>
                      ...
                      {/* <Nav.Item>
                        <Nav.Link eventKey="tab3">
                          ...
                          <svg className="neg-transition-scale" xmlns="http://www.w3.org/2000/svg" width="18" height="18" viewBox="0 0 18 18" fill="none">
                            <path fill-rule="evenodd" clip-rule="evenodd" d="M1.125 9C1.125 8.68934 1.37684 8.4375 1.6875 8.4375H14.9545L11.4148 4.89775C11.1951 4.67808 11.1951 4.32192 11.4148 4.10225C11.6344 3.88258 11.9906 3.88258 12.2102 4.10225L16.7102 8.60225C16.9299 8.82192 16.9299 9.17808 16.7102 9.39775L12.2102 13.8977C11.9906 14.1174 11.6344 14.1174 11.4148 13.8977C11.1951 13.6781 11.1951 13.3219 11.4148 13.1023L14.9545 9.5625H1.6875C1.37684 9.5625 1.125 9.31066 1.125 9Z" fill="#898989"></path>
                          </svg>
                        </Nav.Link>
                      </Nav.Item> */}
                      <Nav.Item onClick={Logout}>
                        <Nav.Link eventKey="tab4">
                          <div className='left-data' >
                            <svg className="neg-transition-scale" xmlns="http://www.w3.org/2000/svg" width="18" height="18" viewBox="0 0 18 18" fill="none">
                              <path d="M12.375 2.8125C12.375 2.19094 11.8716 1.6875 11.25 1.6875H8.71875C8.5635 1.6875 8.4375 1.8135 8.4375 1.96875V2.53125C8.4375 2.6865 8.5635 2.8125 8.71875 2.8125H11.25V4.78125C11.25 4.9365 11.376 5.0625 11.5312 5.0625H12.0938C12.249 5.0625 12.375 4.9365 12.375 4.78125V2.8125Z" fill="#fff"></path>
                              <path d="M11.25 13.2188V15.1875H8.71875C8.5635 15.1875 8.4375 15.3135 8.4375 15.4688V16.0312C8.4375 16.1865 8.5635 16.3125 8.71875 16.3125H11.25C11.8716 16.3125 12.375 15.8091 12.375 15.1875V13.2188C12.375 13.0635 12.249 12.9375 12.0938 12.9375H11.5312C11.376 12.9375 11.25 13.0635 11.25 13.2188Z" fill="#fff"></path>
                              <path d="M8.43766 9.5625C8.43766 9.71775 8.56366 9.84375 8.71891 9.84375H14.0627V11.6134C14.0627 11.6871 14.1515 11.7236 14.2033 11.6719L16.8122 9.063C16.8465 9.02869 16.8465 8.97244 16.8122 8.93812L14.2033 6.32812C14.1515 6.27637 14.0627 6.31294 14.0627 6.38662V8.15625H8.71891C8.56366 8.15625 8.43766 8.28225 8.43766 8.4375V9.5625Z" fill="#fff"></path>
                              <path d="M1.56375 2.73037L6.91425 1.13794C7.11225 1.07887 7.3125 1.224 7.3125 1.4265V16.5684C7.3125 16.7737 7.11 16.9206 6.90919 16.8609L1.56375 15.2696C1.30331 15.192 1.125 14.9569 1.125 14.6902V3.30975C1.125 3.04312 1.30331 2.808 1.56375 2.73037ZM5.0625 9.5625C5.0625 9.87356 5.31394 10.125 5.625 10.125C5.93606 10.125 6.1875 9.87356 6.1875 9.5625V8.4375C6.1875 8.127 5.93606 7.875 5.625 7.875C5.31394 7.875 5.0625 8.127 5.0625 8.4375V9.5625Z" fill="#fff"></path>
                            </svg> Logout
                          </div>
              ...
              <Col sm={8}>
                {isDesktop || showAccountMenu === true ?
                  <Tab.Content className='text-container-box'>
                    <Tab.Pane eventKey="first">
                      {isMobile && showAccountMenu === true ? <svg onClick={() => setShowAccountMenu(!showAccountMenu)} className="neg-transition-scale" xmlns="http://www.w3.org/2000/svg" width="18" height="18" viewBox="0 0 18 18" fill="none">
                        <path fill-rule="evenodd" clip-rule="evenodd" d="M1.125 9C1.125 8.68934 1.37684 8.4375 1.6875 8.4375H14.9545L11.4148 4.89775C11.1951 4.67808 11.1951 4.32192 11.4148 4.10225C11.6344 3.88258 11.9906 3.88258 12.2102 4.10225L16.7102 8.60225C16.9299 8.82192 16.9299 9.17808 16.7102 9.39775L12.2102 13.8977C11.9906 14.1174 11.6344 14.1174 11.4148 13.8977C11.1951 13.6781 11.1951 13.3219 11.4148 13.1023L14.9545 9.5625H1.6875C1.37684 9.5625 1.125 9.31066 1.125 9Z" fill="#898989"></path>
                      </svg> : ' '}
                    ...
                    <Tab.Pane eventKey="second" className='text-container-box'>
                      {isMobile && showAccountMenu === true ? <svg onClick={() => setShowAccountMenu(!showAccountMenu)} className="neg-transition-scale" xmlns="http://www.w3.org/2000/svg" width="18" height="18" viewBox="0 0 18 18" fill="none">
                        <path fill-rule="evenodd" clip-rule="evenodd" d="M1.125 9C1.125 8.68934 1.37684 8.4375 1.6875 8.4375H14.9545L11.4148 4.89775C11.1951 4.67808 11.1951 4.32192 11.4148 4.10225C11.6344 3.88258 11.9906 3.88258 12.2102 4.10225L16.7102 8.60225C16.9299 8.82192 16.9299 9.17808 16.7102 9.39775L12.2102 13.8977C11.9906 14.1174 11.6344 14.1174 11.4148 13.8977C11.1951 13.6781 11.1951 13.3219 11.4148 13.1023L14.9545 9.5625H1.6875C1.37684 9.5625 1.125 9.31066 1.125 9Z" fill="#898989"></path>
                      </svg> : ' '}
                      <Subscription />
                    ...
                    <Tab.Pane eventKey="tab3" className='text-container-box'>
                      {isMobile && showAccountMenu === true ? <svg onClick={() => setShowAccountMenu(!showAccountMenu)} className="neg-transition-scale" xmlns="http://www.w3.org/2000/svg" width="18" height="18" viewBox="0 0 18 18" fill="none">
                        <path fill-rule="evenodd" clip-rule="evenodd" d="M1.125 9C1.125 8.68934 1.37684 8.4375 1.6875 8.4375H14.9545L11.4148 4.89775C11.1951 4.67808 11.1951 4.32192 11.4148 4.10225C11.6344 3.88258 11.9906 3.88258 12.2102 4.10225L16.7102 8.60225C16.9299 8.82192 16.9299 9.17808 16.7102 9.39775L12.2102 13.8977C11.9906 14.1174 11.6344 14.1174 11.4148 13.8977C11.1951 13.6781 11.1951 13.3219 11.4148 13.1023L14.9545 9.5625H1.6875C1.37684 9.5625 1.125 9.31066 1.125 9Z" fill="#898989"></path>
                      </svg> : ' '}
                      <BillingHistory />
